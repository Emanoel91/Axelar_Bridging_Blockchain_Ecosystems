...
top_source_chains = df_destination_chains.loc[df_destination_chains["📤#Source Chains"].idxmax()]
...
with col5:
    st.metric(
        ...
        f"{top_source_chains['📥Destination Chain']} ({top_source_chains['📤#Source Chains']:,})"
    )
with col6:
    st.metric(
